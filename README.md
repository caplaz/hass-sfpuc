...
1. **Download the Integration**:
   ...
   ```bash
   wget https://github.com/caplaz/home-assistant-sfpuc/archive/refs/tags/v1.0.1.zip
   unzip v1.0.1.zip
   ```
...
2. **Copy Files**:
   ...
   ```bash
   cp -r home-assistant-sfpuc-1.0.1/custom_components/sfpuc /config/custom_components/
   ```
